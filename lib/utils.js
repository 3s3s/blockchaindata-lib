...
function SaveBufferToBlockchain (buffer, network = "tBTC")
{
...
exports.SaveJSONToBlockchain = async function(objectJSON, network = "tBTC")
{
...
exports.SplitBalance = async function(count = 10, network = "tBTC")
{
  const minFee = constants.tx.EMPTY_TX_SIZE*constants.tx.FEE_FOR_BYTE;
  const balance = await exports.getbalance();
